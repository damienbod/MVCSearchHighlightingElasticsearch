...
namespace MVCSearchHighlighlingElasticsearch.ElasticsearchProvider
{
	public class SearchProvider
	{
		...
		public void CreateIndexWithDataIfItDoesNotExist()
		{
			if (!_context.IndexExists<FastestAnimal>())
			{
				CreateIndexAndAddData();
			}
		}

		private void CreateIndexAndAddData()
		{
